...
?>   
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox" style="margin-top:100px;">
                        <div class="carousel-item active">
                            <?php if($res['prod_p1'] != ""): ?>
                            <img class="d-block" src="images/<?php echo $res['prod_p1']; ?>" alt="First slide">
                            <?php else: ?>
                        ...
                        <div class="carousel-item">
                            <?php if($res['prod_p2'] != ""): ?>
                            <img class="d-block" src="images/<?php echo $res['prod_p2']; ?>" alt="Second slide">
                            <?php else: ?>
                            <img src="../uploads/default.png">
                            <?php endif; ?>
                            <div class="carousel-caption d-none d-md-block">
                        ...
                        <div class="carousel-item">
                            <?php if($res['prod_p3'] != ""): ?>
                            <img class="d-block" src="images/<?php echo $res['prod_p3']; ?>" alt="Third slide">
                            <?php else: ?>
                            <img src="../uploads/default.png">
                            <?php endif; ?>
                            <div class="carousel-caption d-none d-md-block">
        ...
        <button class="btn btn-success btn-round pull-right" data-toggle="modal" data-target="#myModal" style="background-color:green;">
        <a href="manage_cart.php?prod_id=<?php echo $res['prod_id'];?>" class="btn mr-2" style="background-color:green;"><i class="fa fa-shopping-cart"></i> Add to cart</a></button>
